...
module.exports = [
    {
        name: 'voice (ssml)',
        description: 'text to speech using ssml',
        prefix: '!ssml',
...
async function generateAudio(text) {
    try {
        const request = {
            ...
            voice: {
                languageCode: 'en-US',
                // For whispering, you must specify a Gemini model like 'gemini-tts-1'
                // You may need to replace this with a specific Gemini voice name if necessary.
